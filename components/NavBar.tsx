...
export default function NavBar({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "border-border/60 mx-auto flex h-14 max-w-7xl items-center justify-between rounded-2xl border px-3 transition-all duration-300 sm:px-4",
      ...
      <div className="mx-auto max-w-7xl md:hidden">
        ...
        >
          <div
            className={cn(
              "border-border/60 bg-background/95 mt-2 rounded-2xl border p-3 shadow-lg shadow-black/5 backdrop-blur-xl",
          ...
          >
            ...
            <div className="border-border mt-3 flex items-center justify-between border-t pt-3">
              <div className="text-muted-foreground flex flex-col">
                ...
                <span className="text-xs">Switch between light and dark.</span>
              </div>

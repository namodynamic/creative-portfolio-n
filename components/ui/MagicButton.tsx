...
export default function MagicButton({ title, icon, position = "left", otherClasses, onClick, isBeam = false }: MagicButtonProps) {
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-black-100 px-6 py-1 text-sm font-medium text-white backdrop-blur-3xl">
        {isBeam && (

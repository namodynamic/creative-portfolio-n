...
export function ContactGlobe() {
  ...
  return (
    <div className="relative flex h-full w-full flex-row items-center justify-center bg-transparent md:h-auto">
      <div className="relative mx-auto h-full w-full max-w-7xl px-4 md:h-[40rem]">
        ...
        <div className="absolute  z-10 h-36 md:h-full w-full">

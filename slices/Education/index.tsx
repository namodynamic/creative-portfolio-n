    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        {slice.items.map((item, index) => (
          <Card
            key={index}
            className="mb-12 overflow-hidden border-0 bg-gradient-to-br from-white/20 to-white-50 shadow-xl dark:from-blue-850/50 dark:to-blue-850/80"
          >
              ...
              <div className="flex flex-col gap-8 md:flex-row">
                ...
                <div className="flex items-center justify-center md:w-80">
                  <div className="relative">
                    <div className="absolute -left-4 -top-4 h-48 w-48 rounded-full animate-pulse bg-gradient-to-br from-purple-400 via-violet-500 to-indigo-600 opacity-20"></div>

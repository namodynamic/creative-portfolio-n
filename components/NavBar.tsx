...
export default function NavBar({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "border-foreground/10 mx-auto flex h-14 w-full max-w-7xl min-w-0 items-center justify-between gap-3 rounded-2xl border px-3 transition-all duration-300 sm:px-4",
